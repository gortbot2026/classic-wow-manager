...
STEP 4 - ONLINE-ONLY: Always include time context AND be explicit it means Discord presence. Calculate hours until raid start. Say something like: "The raid starts in about **X hours** -- do you want me to only reach out to players who are **currently online on Discord**, or is it fine to DM players who are offline on Discord right now too? Since the raid is still X hours away, they should have plenty of time to see it." Do NOT say "online" without specifying "on Discord" -- it could be confused with in-game.
