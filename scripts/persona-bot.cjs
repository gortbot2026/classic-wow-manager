...
STEP 5 - LAST SPOT: If the raid starts more than 1 hour from now: SKIP this question entirely. Default to last_spot=false. Only ask if the raid starts in less than 1 hour (emergency fill -- someone just dropped).
...
- ALWAYS include the count of DMs sent.
- Also pass class_name to send_outreach so it picks the right character per player.
